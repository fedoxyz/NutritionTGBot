...
def create_vision_pipeline() -> Callable[[str], ProcessingResult]:
    """Create vision pipeline for receipt processing."""
    model = create_vision_model()

    def vision_pipeline(base64_image: str) -> ProcessingResult:
        return process_image_with_model(base64_image, model)
